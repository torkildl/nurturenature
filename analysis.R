...
###
complete_trios <- fread(here("noncognitive-cognitive/revision/data/complete-trios.csv")) %>% as.data.frame
sibtrios <- fread(here("noncognitive-cognitive/revision/data/sibtrios.csv")) %>% as.data.frame
...
fwrite(results, here("noncognitive-cognitive/revision/output/regression-results-output.txt"))
...
xlsx::write.xlsx2(table1, file = here("noncognitive-cognitive/revision/output/table1-descriptives.xlsx"), col.names = TRUE, sheetName = "Table 1")
...
ggsave(filename = here("noncognitive-cognitive/revision/output/figure1.pdf"), broadplot,
       width = 400,height = 267,units = "mm",  dpi = 320,device = "pdf")
...
ggsave(filename = here("noncognitive-cognitive/revision/output/figureS1-child-nurture-models.pdf"), figureS1,
       width = 400,height = 267,units = "mm",  dpi = 320,device = "pdf")
...
makespecificplot <- function(specoutcome) {
  ...
  thefilename <- here(str_c("noncognitive-cognitive/revision/output/figureS2_",specoutcome,".pdf"))
...
quick_html(maintab_EA4,file = here("noncognitive-cognitive/revision/output/maintab_EA4.html"))
...
maintab_WFEA <-  huxreg(mainmods_WFEA,
                        coefs = keepcoefs, 
                        ci_level = 0.95, error_format = "[{conf.low}, {conf.high}]", error_pos = "right")
quick_html(maintab_WFEA,file = here("noncognitive-cognitive/revision/output/maintab_WFEA.html"))

# for cog/noncog
mainmods_Cog <- c("Sib:Cog:Combined:child_model",
                  "Sib:Cog:Combined:nurture_model",
                  "Sib:Cog:Combined:sibling_model",
                  "Sib:Cog:Combined:uncle_model")
keepcoefs <- c(
  "(Intercept)" = "(Intercept)",
...
maintab_Cog <-  huxreg(all_models[names(all_models) %in% mainmods_Cog],
                       coefs = keepcoefs, 
                       ci_level = 0.95, error_format = "[{conf.low}, {conf.high}]", error_pos = "right")
quick_html(maintab_Cog,file = here("noncognitive-cognitive/revision/output/maintab_Cog.html"))
